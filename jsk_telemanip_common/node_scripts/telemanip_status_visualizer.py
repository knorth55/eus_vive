...
class TelemanipStatusVisualizer(ConnectionBasedTransport):

    def __init__(self):
        super(TelemanipStatusVisualizer, self).__init__()
...
if __name__ == '__main__':
    rospy.init_node('telemanip_status_visualizer')
    app = TelemanipStatusVisualizer()
    rospy.spin()
